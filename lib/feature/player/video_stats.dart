...
/// celui de l'affichage. §tvPlayerPanel — plus rien n'est persisté par ligne
/// (le choix des lignes a été retiré) : la clé ne sert qu'au filtre éventuel
/// de `VideoStatsOverlay.visibleRows`.
enum VideoStatKey {
  decoding,
  output,
  codec,
