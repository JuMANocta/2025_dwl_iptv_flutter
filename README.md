...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.18.13+146-blue?style=flat-square"/>
...
- [ ] **Changer d'onglet, encore plus vite** (§jankNext, mesuré le 2026-09-03 ; le retour du lecteur, lui, est réglé — voir « Terminé ») — après les trois correctifs de septembre, la bascule Accueil ↔ Recherche ↔ Téléchargements coûte encore ~42 ms sur sa pire image : les trois pages restent vivantes en même temps, avec leurs trois carrousels animés. Onze pistes chiffrées, à reprendre à la mesure.
