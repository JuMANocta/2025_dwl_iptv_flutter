...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.15.3+96-blue?style=flat-square"/>
...
- [x] **Plus de flash au lancement** (§splashHandoff, 2026-08-17) — La fenêtre affichée par Android avant le premier rendu Flutter (incompressible : elle existe le temps que le moteur démarre) prend désormais exactement la couleur de l'écran de démarrage, en mode clair **comme** en mode sombre. Fini la marche à l'arrivée de l'app, et fini le flash blanc quand le téléphone est en thème clair
