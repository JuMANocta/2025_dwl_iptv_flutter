...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.18.1+136-blue?style=flat-square"/>
...
- [x] **On sait où l'on est, et ce qu'on déclenche** (§navBlind + §audit0903, 2026-09-04) — Sur téléviseur, viser un bouton et en atteindre un autre était devenu banal dans les pages longues : un **repère de section** nomme désormais en permanence l'endroit où se trouve la sélection — « Films · Coup de cœur », « Optimisation · Listes ». Le raccourci le plus utile de l'application — l'appui long sur une affiche, qui ouvre Lire, Reprendre, Télécharger et Favoris — n'était annoncé nulle part : chaque vignette porte maintenant un « ⋯ ». Les boutons du lecteur, dont l'accès aux options qui mesurait 24 pixels de côté sous une barre qui disparaît en trois secondes, respectent enfin la taille minimale d'une cible tactile ; le texte le plus petit se relève sur téléviseur. Et l'application cesse de confondre « cette série n'a pas d'épisode » avec « le serveur ne répond pas » : le second propose de réessayer. Supprimer un compte annonce désormais ce qui part avec lui — la liste téléchargée, chiffrée — et ce qui reste : favoris, reprises et téléchargements terminés
